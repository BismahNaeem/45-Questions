...
//• Write one version of this program that passes the if test and another that fails. (The version that fails will have no ou

let alienColour = "green";
if(alienColour=="green"){console.log("you just earned 5 points! ")}

alienColour = "yellow";
if(alienColour=="green"){ }
//no output becoz conditon is false